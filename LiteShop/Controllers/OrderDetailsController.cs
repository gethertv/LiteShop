...
namespace LiteShop.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(ApliactionDbContext context)
        {
            _context = context;
        }
        ...
        {
            var apliactionDbContext = _context.OrderDetail.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,ProductId")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,ProductId")] OrderDetail orderDetail)
        {
